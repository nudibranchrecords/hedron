...
import { NodeControl, NodeControlInner, NodeControlMain, NodeControlTitle } from '@hedron/ui-core'
...
export const Param = ({ param: { key, title, id, sketchId, valueType } }: ParamProps) => {
