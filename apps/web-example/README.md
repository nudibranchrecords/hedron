...
A simple example of how to use `@hedron-gl/engine` in your web projects. It's still very low-level, directly using the engine to manipulate things. At some point later we might have a helper package to make things a bit more DX friendly.
