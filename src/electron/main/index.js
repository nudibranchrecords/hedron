...
// The following is to allow electron dev tools to work on windows with dark mode enabled
...
if (process.platform === 'win32') {
  ...
  try {
    ...
    console.error('There was an error unllinking the DevToolsExtensions', e)
  }
}
// End dark mode code
